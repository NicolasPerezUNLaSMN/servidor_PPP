...
// BEGIN MAIN CONTROLLER DESIGN
  ...
  String getFechaTexto(DateTime fecha){
  ...
  static const mainBgColor = Color.fromRGBO(7, 179, 101, 1.0);
  static const mainAlertColor = Color.fromRGBO(146, 5, 29, 1.0);
  static const mainBgColorLighter = Color.fromRGBO(85, 222, 114, 1.0);
  static const mainItemBgColor = Color.fromRGBO(4, 227, 70, 0.9019607843137255);
  static const mainItemDeletedBgColor = Color.fromRGBO(111, 14, 33, .9);
  static const mainTextColor = Colors.white;
  static const mainTextColorAlternative = Color.fromRGBO(46, 118, 2, 1.0);
  ...
  static const mainDatePickerLocaleType = LocaleType.es;
